...
from common.msg import RigidBodyState, Vector3LL
...
class MTI630(BaseIMU):
    def __init__(self, name, cfg, ros_node: RosNode):
        super(MTI630, self).__init__(name, cfg, ros_node)
        subs_qos = QoSProfile(
        ...
        # self.publisher = ros_node.create_publisher(RigidBodyState, f"/imu/mti630", subs_qos)
